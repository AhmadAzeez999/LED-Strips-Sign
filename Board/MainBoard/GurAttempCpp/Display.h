...
private:
  ...
  void drawCharacter15x15Fixed(char c, int x, int y, uint32_t color);
  bool isTimerFormat(const char* str);
  ...
  void strobeText(const char* text1, const char* text2, bool useBigFont);
  void marqueeText(const char* text1, const char* text2, bool useBigFont);
